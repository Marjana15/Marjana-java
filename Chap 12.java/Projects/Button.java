/* A Simple Calculator using JOptionpane and ActionListener with the conditional statements also used Message Dialog to Show Message and Input Dialog to take Inputs*/
    ...
    private class ButtonHandler implements ActionListener 
    {
        public void actionPerformed( ActionEvent event )
        {
            ...
            if(event.getSource() == Button2)
            {
                ...
                JOptionPane.showMessageDialog( null, "The Subtraction is " + Substraction, "Substraction of Two Integers", JOptionPane.INFORMATION_MESSAGE );
            }
            ...
            if(event.getSource() == Button3)
            {
                ...
                JOptionPane.showMessageDialog( null, "The Multiplication is " + Multiplication, "Multiplication of Two Integers", JOptionPane.INFORMATION_MESSAGE );
            }
            ...
            if(event.getSource() == Button4)
            {
                ...
                JOptionPane.showMessageDialog( null, "The Division is " + Division, "Division of Two Integers", JOptionPane.INFORMATION_MESSAGE );
            }
        }
    }
